...
namespace FileService.Domain.Entities
{
    public record UploadedItem : BaseEntity, IHasCreationTime
    {
        ...
        // private UploadedItem(DateTime creationTime, long fileSizeInBytes, string fileName, string fileSha256Hash, Uri backupUrl, Uri remoteUrl)
        // {
